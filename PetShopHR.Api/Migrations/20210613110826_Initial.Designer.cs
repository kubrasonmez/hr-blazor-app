...
namespace PetShopHR.Api.Migrations
{
    ...
    [Migration("20210613110826_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetShopHR.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("PetShopHR.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("PetShopHR.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PetShopHR.Shared.Employee", b =>
                {
                    b.HasOne("PetShopHR.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PetShopHR.Shared.JobCategory", "JobCategory")
                        .WithMany()
